...
echo "<form name='form' method='post' action=\"".$_SERVER['PHP_SELF'].
   ...
   $origMonth."&day=".$origDay."&tyear=".$tcurYear."&tmonth=".$tcurMonth."&tday=".$tcurDay."&crop=".
   encodeURIComponent($origCrop)."&fieldID=".encodeURIComponent($origFieldID)."&disease=".
...
if (isset($_POST['submit'])) {
   ...
   if(!$result){
      ...
      echo '<meta http-equiv="refresh" content="0;URL=diseaseTable.php?year='.$origYear.'&month='.
        ...
        encodeURIComponent($origFieldID)."&crop=".encodeURIComponent($origCrop)."&disease=".

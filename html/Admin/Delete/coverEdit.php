...
//$sqlget = "SELECT id, year(seedDate) as yr, month(seedDate) as mth, day(seedDate) as dy, crop1, seedRate1, num_pounds1,
	//crop2, seedRate2, num_pounds2, area_seeded, seed_method, incorp_tool, fieldID, seedDate, comments
	//FROM coverSeed WHERE id = ".$id;
...
echo "<form name='form' method='POST' action=\"".$SERVER['PHP_SELF'].
   "?tab=admin:admin_delete:deletesoil:deletefert:deletecover:deletecoverseed
...
if ($_POST['submit']) {
   ...
   /*echo $sql = "UPDATE coverSeed 
		SET comments='".$comments."', seedDate='".$year."-".$month."-".$day."', 
		crop1='".$crop1."', seedRate1=".$seedRate1.", num_pounds1=".$num_pounds1.", 
		crop2='".$crop2."', seedRate2=".$seedRate2.", num_pounds2=".$num_pounds2.",
		fieldID='".$fieldID."', area_seeded=".$area_seeded.", seed_method='".$seed_method."', incorp_tool='".$incorp_tool."'
		WHERE id=".$id;*/

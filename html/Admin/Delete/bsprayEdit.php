...
echo "<form name='form' method='post' action=\"".$_SERVER['PHP_SELF'].
   "?tab=admin:admin_delete:deletesoil:deletespray:deletebspray&year=".$origYear."&month=".$origMonth."&day=".$origDay.
...
if ($_POST['submit']) {
   ...
   if(!$result){
      ...
      echo '<meta http-equiv="refresh" content="0;URL=bsprayTable.php?year='.$origYear.'&month='.$origMonth.

...
<table id='covercrop' name='covercrop'>
	<tr><th>Species</th><th>Rate of Seed</th><th>Total Pounds</th></tr>
</table>
<script type='text/javascript'>
	var numRows=0;
	function addRow(){
...
if(!empty($_POST['submit'])) {
   ...
   $seed_method = escapehtml($_POST['seed_method']);
	$sqlcoverSeedMaster = "Insert into coverSeed_master (seed_method,incorp_tool,comments,seedDate,fieldID,area_seeded) values('".$seed_method."', '".$incorp_tool."','".$comments."','".$_POST['year']."-".$_POST['month']."-".$_POST['day']."','".$fieldID."', $percent)";
